...
/**
 * ServerActionRequestVolumes Class Doc Comment
 *
 * @category Class
 * @description For each volume UUID, the snapshot parameters of the volume. For each volume UUID, the snapshot parameters of the volume. This field should only be specified when performing a backup action.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ServerActionRequestVolumes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServerAction_request_volumes';
    ...
    protected static $openAPITypes = [
        'volume_key' => '\OpenAPI\Client\Model\ScalewayInstanceV1ServerActionRequestVolumeBackupTemplate'
    ];
    ...
    {
        $this->setIfExists('volume_key', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets volume_key
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1ServerActionRequestVolumeBackupTemplate|null
     */
    public function getVolumeKey()
    {
        return $this->container['volume_key'];
    }

    /**
     * Sets volume_key
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1ServerActionRequestVolumeBackupTemplate|null $volume_key volume_key
     *
     * @return self
     */
    public function setVolumeKey($volume_key)
    {
        if (is_null($volume_key)) {
            throw new \InvalidArgumentException('non-nullable volume_key cannot be null');
        }
        $this->container['volume_key'] = $volume_key;
