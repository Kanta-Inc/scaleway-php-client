...
/**
 * ScalewayInstanceV1PlacementGroup Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1PlacementGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway.instance.v1.PlacementGroup';
    ...
    */
     ...
     *
     * @param bool|null $policy_respected Returns true if the policy is respected, false otherwise.
     *
     * @return self
     */
