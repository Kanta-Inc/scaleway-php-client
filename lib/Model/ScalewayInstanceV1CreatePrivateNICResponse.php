...
/**
 * ScalewayInstanceV1CreatePrivateNICResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1CreatePrivateNICResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway.instance.v1.CreatePrivateNICResponse';
    ...
    protected static $openAPITypes = [
        'private_nic' => '\OpenAPI\Client\Model\ScalewayInstanceV1PrivateNIC'
    ];
    ...
    {
        $this->setIfExists('private_nic', $data ?? [], null);
    }
    ...
    */
     ...
     */
    public function getPrivateNic()
    {
        return $this->container['private_nic'];
    }

    /**
     * Sets private_nic
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1PrivateNIC|null $private_nic private_nic
     *
     * @return self
     */
    public function setPrivateNic($private_nic)
    {
        if (is_null($private_nic)) {
            throw new \InvalidArgumentException('non-nullable private_nic cannot be null');
        }
        $this->container['private_nic'] = $private_nic;
