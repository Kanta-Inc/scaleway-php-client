...
/**
 * ExportSnapshotRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExportSnapshotRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExportSnapshot_request';
    ...
    */
     ...
     * Sets bucket
     *
     * @param string|null $bucket S3 bucket name.
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string|null $key S3 object key.
     *
     * @return self
     */
