...
/**
 * ScalewayInstanceV1MigrationPlanVolume Class Doc Comment
 *
 * @category Class
 * @description A volume which will be migrated to SBS together with the snapshots, if present.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ScalewayInstanceV1MigrationPlanVolume implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway_instance_v1_MigrationPlan_volume';
    ...
    protected static $openAPITypes = [
        ...
        'project' => 'string',
        'tags' => 'string[]',
        'server' => '\OpenAPI\Client\Model\SetVolumeRequestServer',
        'state' => 'string',
        'zone' => 'string'
    ];
    ...
    public const STATE_FETCHING = 'fetching';
    public const STATE_RESIZING = 'resizing';
    public const STATE_SAVING = 'saving';
    public const STATE_HOTSYNCING = 'hotsyncing';
    ...
    public function getStateAllowableValues()
    {
        return [
            ...
            self::STATE_SNAPSHOTTING,
            self::STATE_ERROR,
            self::STATE_FETCHING,
            self::STATE_RESIZING,
            self::STATE_SAVING,
            self::STATE_HOTSYNCING,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('export_uri', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Volume unique ID.
     *
     * @return self
     */
    ...
    {
        return $this->container['export_uri'];
    }

    /**
     * Sets export_uri
     *
     * @param string|null $export_uri Show the volume NBD export URI.
     *
     * @return self
     * @deprecated
     */
    public function setExportUri($export_uri)
    {
        if (is_null($export_uri)) {
            throw new \InvalidArgumentException('non-nullable export_uri cannot be null');
        }
        $this->container['export_uri'] = $export_uri;
     ...
     * Sets size
     *
     * @param int|null $size Volume disk size. (in bytes)
     *
     * @return self
     */
     ...
     * Sets volume_type
     *
     * @param string|null $volume_type Volume type.
     *
     * @return self
     */
     ...
     * Sets creation_date
     *
     * @param \DateTime|null $creation_date Volume creation date. (RFC 3339 format)
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $modification_date Volume modification date. (RFC 3339 format)
     *
     * @return self
     */
     ...
     * Sets organization
     *
     * @param string|null $organization Volume Organization ID.
     *
     * @return self
     */
     ...
     * Sets project
     *
     * @param string|null $project Volume Project ID.
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags Volume tags.
     *
     * @return self
     */
     ...
     * Gets server
     *
     * @return \OpenAPI\Client\Model\SetVolumeRequestServer|null
     */
     ...
     * Sets server
     *
     * @param \OpenAPI\Client\Model\SetVolumeRequestServer|null $server server
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string|null $state Volume state.
     *
     * @return self
     */
     ...
     * Sets zone
     *
     * @param string|null $zone Zone in which the volume is located.
     *
     * @return self
     */
