...
/**
 * ScalewayInstanceV1GetServerTypesAvailabilityResponseServers Class Doc Comment
 *
 * @category Class
 ...
 */
class ScalewayInstanceV1GetServerTypesAvailabilityResponseServers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway_instance_v1_GetServerTypesAvailabilityResponse_servers';
    ...
    protected static $openAPITypes = [
        'server_key' => '\OpenAPI\Client\Model\ScalewayInstanceV1GetServerTypesAvailabilityResponseAvailability'
    ];
    ...
    {
        $this->setIfExists('server_key', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets server_key
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1GetServerTypesAvailabilityResponseAvailability|null
     */
    public function getServerKey()
    {
        return $this->container['server_key'];
    }

    /**
     * Sets server_key
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1GetServerTypesAvailabilityResponseAvailability|null $server_key server_key
     *
     * @return self
     */
    public function setServerKey($server_key)
    {
        if (is_null($server_key)) {
            throw new \InvalidArgumentException('non-nullable server_key cannot be null');
        }
        $this->container['server_key'] = $server_key;
