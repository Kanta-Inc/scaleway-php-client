...
/**
 * UpdateSecurityGroupRuleRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateSecurityGroupRuleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateSecurityGroupRule_request';
    ...
    */
    ...
    {
        if (is_null($ip_range)) {
            array_push($this->openAPINullablesSetToNull, 'ip_range');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ip_range', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets dest_port_from
     *
     * @param int|null $dest_port_from Beginning of the range of ports this rule applies to (inclusive). If 0 is provided, unset the parameter.
     *
     * @return self
     */
     ...
     * Sets dest_port_to
     *
     * @param int|null $dest_port_to End of the range of ports this rule applies to (inclusive). If 0 is provided, unset the parameter.
     *
     * @return self
     */
