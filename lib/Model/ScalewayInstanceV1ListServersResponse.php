...
/**
 * ScalewayInstanceV1ListServersResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1ListServersResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway.instance.v1.ListServersResponse';
    ...
    protected static $openAPITypes = [
        'servers' => '\OpenAPI\Client\Model\ScalewayInstanceV1Server[]'
    ];
    ...
    */
     ...
     * Sets servers
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1Server[]|null $servers List of Instances.
     *
     * @return self
     */
