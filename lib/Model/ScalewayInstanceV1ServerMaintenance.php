...
/**
 * ScalewayInstanceV1ServerMaintenance Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1ServerMaintenance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway.instance.v1.Server.Maintenance';
    ...
    */
     ...
     * Sets start_date
     *
     * @param \DateTime|null $start_date (RFC 3339 format)
     *
     * @return self
     */
