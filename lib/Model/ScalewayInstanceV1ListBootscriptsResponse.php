...
/**
 * ScalewayInstanceV1ListBootscriptsResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1ListBootscriptsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway.instance.v1.ListBootscriptsResponse';
    ...
    protected static $openAPITypes = [
        'bootscripts' => '\OpenAPI\Client\Model\ScalewayInstanceV1Bootscript[]'
    ];
    ...
    {
        $this->setIfExists('bootscripts', $data ?? [], null);
    }
    ...
    */
     ...
     */
    public function getBootscripts()
    {
        return $this->container['bootscripts'];
    }

    /**
     * Sets bootscripts
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1Bootscript[]|null $bootscripts List of bootscripts.
     *
     * @return self
     */
    public function setBootscripts($bootscripts)
    {
        if (is_null($bootscripts)) {
            throw new \InvalidArgumentException('non-nullable bootscripts cannot be null');
        }
        $this->container['bootscripts'] = $bootscripts;
