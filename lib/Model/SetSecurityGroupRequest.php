...
/**
 * SetSecurityGroupRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SetSecurityGroupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetSecurityGroup_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Name of the security group.
     *
     * @return self
     */
     ...
     * Sets creation_date
     *
     * @param \DateTime|null $creation_date Creation date of the security group (will be ignored). (RFC 3339 format)
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $modification_date Modification date of the security group (will be ignored). (RFC 3339 format)
     *
     * @return self
     */
     ...
     * Sets organization
     *
     * @param string|null $organization Security groups Organization ID.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $organization_default Please use project_default instead.
     *
     * @return self
     * @deprecated
     */
     ...
     *
     * @param bool|null $project_default True use this security group for future Instances created in this project.
     *
     * @return self
     */
     ...
     * Sets servers
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1ServerSummary[]|null $servers Instances attached to this security group.
     *
     * @return self
     */
     ...
     * Sets stateful
     *
     * @param bool|null $stateful True to set the security group as stateful.
     *
     * @return self
     */
