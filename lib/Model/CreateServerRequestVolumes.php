...
/**
 * CreateServerRequestVolumes Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateServerRequestVolumes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateServer_request_volumes';
