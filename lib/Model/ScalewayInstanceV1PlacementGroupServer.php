...
/**
 * ScalewayInstanceV1PlacementGroupServer Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1PlacementGroupServer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway.instance.v1.PlacementGroupServer';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Instance UUID.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $policy_respected Defines whether the placement group policy is respected (either 1 or 0).
     *
     * @return self
     */
