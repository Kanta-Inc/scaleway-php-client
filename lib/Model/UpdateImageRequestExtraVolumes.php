...
/**
 * UpdateImageRequestExtraVolumes Class Doc Comment
 *
 * @category Class
 * @description Additional snapshots of the image, with extra_volumeKey being the position of the snapshot in the image.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateImageRequestExtraVolumes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateImage_request_extra_volumes';
    ...
    protected static $openAPITypes = [
        'extra_volume_key' => '\OpenAPI\Client\Model\ScalewayInstanceV1VolumeImageUpdateTemplate'
    ];
    ...
    protected static $attributeMap = [
        'extra_volume_key' => '&lt;extra_volumeKey&gt;'
    ];
    ...
    protected static $setters = [
        'extra_volume_key' => 'setExtraVolumeKey'
    ];
    ...
    protected static $getters = [
        'extra_volume_key' => 'getExtraVolumeKey'
    ];
    ...
    {
        $this->setIfExists('extra_volume_key', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets extra_volume_key
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1VolumeImageUpdateTemplate|null
     */
    public function getExtraVolumeKey()
    {
        return $this->container['extra_volume_key'];
    }

    /**
     * Sets extra_volume_key
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1VolumeImageUpdateTemplate|null $extra_volume_key extra_volume_key
     *
     * @return self
     */
    public function setExtraVolumeKey($extra_volume_key)
    {
        if (is_null($extra_volume_key)) {
            throw new \InvalidArgumentException('non-nullable extra_volume_key cannot be null');
        }
        $this->container['extra_volume_key'] = $extra_volume_key;
