...
/**
 * ScalewayInstanceV1ListPlacementGroupsResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1ListPlacementGroupsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway.instance.v1.ListPlacementGroupsResponse';
    ...
    protected static $openAPITypes = [
        'placement_groups' => '\OpenAPI\Client\Model\ScalewayInstanceV1PlacementGroup[]'
    ];
    ...
    protected static $setters = [
        'placement_groups' => 'setPlacementGroups'
    ];
    ...
    protected static $getters = [
        'placement_groups' => 'getPlacementGroups'
    ];
    ...
    {
        $this->setIfExists('placement_groups', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets placement_groups
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1PlacementGroup[]|null
     */
    public function getPlacementGroups()
    {
        return $this->container['placement_groups'];
    }

    /**
     * Sets placement_groups
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1PlacementGroup[]|null $placement_groups List of placement groups.
     *
     * @return self
     */
    public function setPlacementGroups($placement_groups)
    {
        if (is_null($placement_groups)) {
            throw new \InvalidArgumentException('non-nullable placement_groups cannot be null');
        }
        $this->container['placement_groups'] = $placement_groups;
