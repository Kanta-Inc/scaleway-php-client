...
/**
 * ScalewayInstanceV1Snapshot Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1Snapshot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway.instance.v1.Snapshot';
    ...
    protected static $openAPITypes = [
        ...
        'size' => 'int',
        'state' => 'string',
        'base_volume' => '\OpenAPI\Client\Model\ScalewayInstanceV1SnapshotBaseVolume',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('base_volume', $data ?? [], null);
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Snapshot name.
     *
     * @return self
     */
     ...
     * Sets organization
     *
     * @param string|null $organization Snapshot Organization ID.
     *
     * @return self
     */
     ...
     * Sets project
     *
     * @param string|null $project Snapshot Project ID.
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags Snapshot tags.
     *
     * @return self
     */
     ...
     * Sets volume_type
     *
     * @param string|null $volume_type Snapshot volume type.
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string|null $state Snapshot state.
     *
     * @return self
     */
     ...
     * Gets base_volume
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1SnapshotBaseVolume|null
     */
     ...
     * Sets base_volume
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1SnapshotBaseVolume|null $base_volume base_volume
     *
     * @return self
     */
    public function setBaseVolume($base_volume)
    {
        if (is_null($base_volume)) {
            throw new \InvalidArgumentException('non-nullable base_volume cannot be null');
        }
     ...
     * Sets creation_date
     *
     * @param \DateTime|null $creation_date Snapshot creation date. (RFC 3339 format)
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $modification_date Snapshot modification date. (RFC 3339 format)
     *
     * @return self
     */
     ...
     * Sets error_reason
     *
     * @param string|null $error_reason Reason for the failed snapshot import.
     *
     * @return self
     */
