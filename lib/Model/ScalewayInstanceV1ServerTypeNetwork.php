...
/**
 * ScalewayInstanceV1ServerTypeNetwork Class Doc Comment
 *
 * @category Class
 ...
 */
class ScalewayInstanceV1ServerTypeNetwork implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway_instance_v1_ServerType_network';
    ...
    protected static $openAPITypes = [
        'interfaces' => '\OpenAPI\Client\Model\ScalewayInstanceV1ServerTypeNetworkInterface[]',
        'sum_internal_bandwidth' => 'int',
        'sum_internet_bandwidth' => 'int',
        'ipv6_support' => 'bool'
    ];
    ...
    protected static array $openAPINullables = [
        'interfaces' => false,
        'sum_internal_bandwidth' => true,
        'sum_internet_bandwidth' => true,
        'ipv6_support' => false
    ];
    ...
    protected static $setters = [
        ...
        'sum_internal_bandwidth' => 'setSumInternalBandwidth',
        'sum_internet_bandwidth' => 'setSumInternetBandwidth',
        'ipv6_support' => 'setIpv6Support'
    ];
    ...
    protected static $getters = [
        ...
        'sum_internal_bandwidth' => 'getSumInternalBandwidth',
        'sum_internet_bandwidth' => 'getSumInternetBandwidth',
        'ipv6_support' => 'getIpv6Support'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sum_internal_bandwidth', $data ?? [], null);
        $this->setIfExists('sum_internet_bandwidth', $data ?? [], null);
        $this->setIfExists('ipv6_support', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets interfaces
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1ServerTypeNetworkInterface[]|null
     */
     ...
     * Sets interfaces
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1ServerTypeNetworkInterface[]|null $interfaces List of available network interfaces.
     *
     * @return self
     */
    ...
    /**
     * Gets sum_internal_bandwidth
     *
     * @return int|null
     */
    public function getSumInternalBandwidth()
    {
        return $this->container['sum_internal_bandwidth'];
    }

    /**
     * Sets sum_internal_bandwidth
     *
     * @param int|null $sum_internal_bandwidth Total maximum internal bandwidth in bits per seconds.
     *
     * @return self
     */
    public function setSumInternalBandwidth($sum_internal_bandwidth)
    {
        if (is_null($sum_internal_bandwidth)) {
            array_push($this->openAPINullablesSetToNull, 'sum_internal_bandwidth');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sum_internal_bandwidth', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['sum_internal_bandwidth'] = $sum_internal_bandwidth;

        return $this;
    }

    /**
     * Gets sum_internet_bandwidth
     *
     * @return int|null
     */
    public function getSumInternetBandwidth()
    {
        return $this->container['sum_internet_bandwidth'];
    }

    /**
     * Sets sum_internet_bandwidth
     *
     * @param int|null $sum_internet_bandwidth Total maximum internet bandwidth in bits per seconds.
     *
     * @return self
     */
    public function setSumInternetBandwidth($sum_internet_bandwidth)
    {
        if (is_null($sum_internet_bandwidth)) {
            array_push($this->openAPINullablesSetToNull, 'sum_internet_bandwidth');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sum_internet_bandwidth', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['sum_internet_bandwidth'] = $sum_internet_bandwidth;
    ...
    {
        return $this->container['ipv6_support'];
    }

    /**
     * Sets ipv6_support
     *
     * @param bool|null $ipv6_support True if IPv6 is enabled.
     *
     * @return self
     */
    public function setIpv6Support($ipv6_support)
    {
        if (is_null($ipv6_support)) {
            throw new \InvalidArgumentException('non-nullable ipv6_support cannot be null');
        }
        $this->container['ipv6_support'] = $ipv6_support;
