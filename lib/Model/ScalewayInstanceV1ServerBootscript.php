...
/**
 * ScalewayInstanceV1ServerBootscript Class Doc Comment
 *
 * @category Class
 * @description Instance bootscript.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ScalewayInstanceV1ServerBootscript implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway_instance_v1_Server_bootscript';
    ...
    {
        $this->setIfExists('bootcmdargs', $data ?? [], null);
        $this->setIfExists('default', $data ?? [], null);
        $this->setIfExists('dtb', $data ?? [], null);
        $this->setIfExists('id', $data ?? [], null);
        $this->setIfExists('initrd', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getBootcmdargs()
    {
        return $this->container['bootcmdargs'];
    }

    /**
     * Sets bootcmdargs
     *
     * @param string|null $bootcmdargs Bootscript arguments.
     *
     * @return self
     */
    public function setBootcmdargs($bootcmdargs)
    {
        if (is_null($bootcmdargs)) {
            throw new \InvalidArgumentException('non-nullable bootcmdargs cannot be null');
        }
        $this->container['bootcmdargs'] = $bootcmdargs;
     ...
     * Sets default
     *
     * @param bool|null $default Display if the bootscript is the default bootscript (if no other boot option is configured).
     *
     * @return self
     */
    ...
    {
        return $this->container['dtb'];
    }

    /**
     * Sets dtb
     *
     * @param string|null $dtb Provide information regarding a Device Tree Binary (DTB) for use with C1 servers.
     *
     * @return self
     */
    ...
    {
        if (is_null($dtb)) {
            throw new \InvalidArgumentException('non-nullable dtb cannot be null');
        }
        $this->container['dtb'] = $dtb;
     ...
     * Sets id
     *
     * @param string|null $id Bootscript ID.
     *
     * @return self
     */
    ...
    {
        return $this->container['initrd'];
    }

    /**
     * Sets initrd
     *
     * @param string|null $initrd Initrd (initial ramdisk) configuration.
     *
     * @return self
     */
    ...
    {
        if (is_null($initrd)) {
            throw new \InvalidArgumentException('non-nullable initrd cannot be null');
        }
        $this->container['initrd'] = $initrd;
     ...
     * Sets kernel
     *
     * @param string|null $kernel Instance kernel version.
     *
     * @return self
     */
    ...
    {
        if (is_null($kernel)) {
            throw new \InvalidArgumentException('non-nullable kernel cannot be null');
        }
     ...
     * Sets organization
     *
     * @param string|null $organization Bootscript Organization ID.
     *
     * @return self
     */
     ...
     * Sets project
     *
     * @param string|null $project Bootscript Project ID.
     *
     * @return self
     */
     ...
     * Sets public
     *
     * @param bool|null $public Provide information if the bootscript is public.
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title Bootscript title.
     *
     * @return self
     */
     ...
     * Sets arch
     *
     * @param string|null $arch Bootscript architecture.
     *
     * @return self
     */
     ...
     * Sets zone
     *
     * @param string|null $zone Zone in which the bootscript is located.
     *
     * @return self
     */
