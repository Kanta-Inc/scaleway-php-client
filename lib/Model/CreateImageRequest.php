...
class CreateImageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateImage_request';
    ...
    protected static $openAPITypes = [
        ...
        'extra_volumes' => '\OpenAPI\Client\Model\CreateImageRequestExtraVolumes',
        'organization' => 'string',
        'project' => 'string',
        'tags' => 'string[]',
        'public' => 'bool'
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['root_volume'] === null) {
            $invalidProperties[] = "'root_volume' can't be null";
        }
     ...
     * Sets name
     *
     * @param string|null $name Name of the image.
     *
     * @return self
     */
     ...
     * Sets root_volume
     *
     * @param string $root_volume UUID of the snapshot.
     *
     * @return self
     */
     ...
     * Sets arch
     *
     * @param string $arch Architecture of the image.
     *
     * @return self
     */
     ...
     *
     * @param string|null $default_bootscript Default bootscript of the image.
     *
     * @return self
     * @deprecated
     */
    public function setDefaultBootscript($default_bootscript)
    {
        if (is_null($default_bootscript)) {
            array_push($this->openAPINullablesSetToNull, 'default_bootscript');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('default_bootscript', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets extra_volumes
     *
     * @return \OpenAPI\Client\Model\CreateImageRequestExtraVolumes|null
     */
     ...
     * Sets extra_volumes
     *
     * @param \OpenAPI\Client\Model\CreateImageRequestExtraVolumes|null $extra_volumes extra_volumes
     *
     * @return self
     */
     ...
     * Sets organization
     *
     * @param string|null $organization Organization ID of the image.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets project
     *
     * @param string|null $project Project ID of the image.
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags Tags of the image.
     *
     * @return self
     */
     ...
     * Sets public
     *
     * @param bool|null $public True to create a public image.
     *
     * @return self
     */
