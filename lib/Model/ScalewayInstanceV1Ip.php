...
/**
 * ScalewayInstanceV1Ip Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1Ip implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway.instance.v1.Ip';
    ...
    protected static $openAPITypes = [
        ...
        'tags' => 'string[]',
        'project' => 'string',
        'type' => '\OpenAPI\Client\Model\ScalewayInstanceV1IpType',
        'state' => '\OpenAPI\Client\Model\ScalewayInstanceV1IpState',
        'prefix' => 'string',
        'ipam_id' => 'string',
        'zone' => 'string'
    ];
    ...
    */
     ...
     * Sets reverse
     *
     * @param string|null $reverse reverse
     *
     * @return self
     */
    ...
    {
        if (is_null($reverse)) {
            array_push($this->openAPINullablesSetToNull, 'reverse');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reverse', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1IpType|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1IpType|null $type type
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1IpState|null
     */
     ...
     * Sets state
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1IpState|null $state state
     *
     * @return self
     */
     ...
     * Sets prefix
     *
     * @param string|null $prefix (IP network)
     *
     * @return self
     */
     ...
     * Sets ipam_id
     *
     * @param string|null $ipam_id (UUID format)
     *
     * @return self
     */
