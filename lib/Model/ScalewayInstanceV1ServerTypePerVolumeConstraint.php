...
/**
 * ScalewayInstanceV1ServerTypePerVolumeConstraint Class Doc Comment
 *
 * @category Class
 ...
 */
class ScalewayInstanceV1ServerTypePerVolumeConstraint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway_instance_v1_ServerType_per_volume_constraint';
    ...
    protected static $openAPITypes = [
        'l_ssd' => '\OpenAPI\Client\Model\ScalewayInstanceV1ServerTypePerVolumeConstraintLSsd'
    ];
    ...
    {
        $this->setIfExists('l_ssd', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets l_ssd
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1ServerTypePerVolumeConstraintLSsd|null
     */
    public function getLSsd()
    {
        return $this->container['l_ssd'];
    }

    /**
     * Sets l_ssd
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1ServerTypePerVolumeConstraintLSsd|null $l_ssd l_ssd
     *
     * @return self
     */
    public function setLSsd($l_ssd)
    {
        if (is_null($l_ssd)) {
            throw new \InvalidArgumentException('non-nullable l_ssd cannot be null');
        }
        $this->container['l_ssd'] = $l_ssd;
