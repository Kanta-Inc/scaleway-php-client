...
/**
 * ScalewayInstanceV1ServerTypeCapabilities Class Doc Comment
 *
 * @category Class
 ...
 */
class ScalewayInstanceV1ServerTypeCapabilities implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway_instance_v1_ServerType_capabilities';
    ...
    protected static $openAPITypes = [
        'block_storage' => 'bool',
        'boot_types' => '\OpenAPI\Client\Model\ScalewayInstanceV1BootType[]'
    ];
    ...
    protected static $setters = [
        'block_storage' => 'setBlockStorage',
        'boot_types' => 'setBootTypes'
    ];
    ...
    protected static $getters = [
        'block_storage' => 'getBlockStorage',
        'boot_types' => 'getBootTypes'
    ];
    ...
    {
        $this->setIfExists('block_storage', $data ?? [], null);
        $this->setIfExists('boot_types', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['block_storage'];
    }

    /**
     * Sets block_storage
     *
     * @param bool|null $block_storage Defines whether the Instance supports block storage.
     *
     * @return self
     */
    public function setBlockStorage($block_storage)
    {
        if (is_null($block_storage)) {
            array_push($this->openAPINullablesSetToNull, 'block_storage');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('block_storage', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['block_storage'] = $block_storage;
     ...
     */
    public function getBootTypes()
    {
        return $this->container['boot_types'];
    }

    /**
     * Sets boot_types
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1BootType[]|null $boot_types List of supported boot types.
     *
     * @return self
     */
    public function setBootTypes($boot_types)
    {
        if (is_null($boot_types)) {
            throw new \InvalidArgumentException('non-nullable boot_types cannot be null');
        }
        $this->container['boot_types'] = $boot_types;
