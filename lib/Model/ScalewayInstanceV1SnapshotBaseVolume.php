...
/**
 * ScalewayInstanceV1SnapshotBaseVolume Class Doc Comment
 *
 * @category Class
 ...
 */
class ScalewayInstanceV1SnapshotBaseVolume implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway_instance_v1_Snapshot_base_volume';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Volume ID on which the snapshot is based.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Volume name on which the snapshot is based on.
     *
     * @return self
     */
