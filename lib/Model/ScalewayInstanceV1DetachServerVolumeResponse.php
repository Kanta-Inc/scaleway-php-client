...
/**
 * ScalewayInstanceV1DetachServerVolumeResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1DetachServerVolumeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway.instance.v1.DetachServerVolumeResponse';
    ...
    protected static $openAPITypes = [
        'server' => '\OpenAPI\Client\Model\ScalewayInstanceV1Server'
    ];
    ...
    */
     ...
     * Gets server
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1Server|null
     */
     ...
     * Sets server
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1Server|null $server server
     *
     * @return self
     */
