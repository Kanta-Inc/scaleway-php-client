...
/**
 * CreateIpRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateIpRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateIp_request';
    ...
    public const TYPE_UNKNOWN_IPTYPE = 'unknown_iptype';
    public const TYPE_NAT = 'nat';
    public const TYPE_ROUTED_IPV4 = 'routed_ipv4';
    public const TYPE_ROUTED_IPV6 = 'routed_ipv6';
    ...
    {
        return [
            self::TYPE_UNKNOWN_IPTYPE,
            self::TYPE_NAT,
            self::TYPE_ROUTED_IPV4,
            self::TYPE_ROUTED_IPV6,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('type', $data ?? [], 'unknown_iptype');
    }
    ...
    */
     ...
     * Sets organization
     *
     * @param string|null $organization Organization ID in which the IP is reserved.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets project
     *
     * @param string|null $project Project ID in which the IP is reserved.
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags Tags of the IP.
     *
     * @return self
     */
     ...
     * Sets server
     *
     * @param string|null $server UUID of the Instance you want to attach the IP to.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type IP type to reserve (either 'nat', 'routed_ipv4' or 'routed_ipv6').
     *
     * @return self
     */
