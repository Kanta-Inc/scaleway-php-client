...
/**
 * ScalewayInstanceV1PrivateNIC Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1PrivateNIC implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway.instance.v1.PrivateNIC';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Private NIC unique ID.
     *
     * @return self
     */
     ...
     * Sets server_id
     *
     * @param string|null $server_id Instance to which the private NIC is attached.
     *
     * @return self
     */
     ...
     *
     * @param string|null $private_network_id Private Network the private NIC is attached to.
     *
     * @return self
     */
     ...
     * Sets mac_address
     *
     * @param string|null $mac_address Private NIC MAC address.
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string|null $state Private NIC state.
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags Private NIC tags.
     *
     * @return self
     */
