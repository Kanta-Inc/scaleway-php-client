...
/**
 * ApplyBlockMigrationRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApplyBlockMigrationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplyBlockMigration_request';
    ...
    */
     ...
     * Sets volume_id
     *
     * @param string|null $volume_id The volume to migrate, along with potentially other resources, according to the migration plan generated with a call to PlanBlockMigration.
     *
     * @return self
     */
     ...
     * Sets snapshot_id
     *
     * @param string|null $snapshot_id The snapshot to migrate, along with potentially other resources, according to the migration plan generated with a call to PlanBlockMigration.
     *
     * @return self
     */
     ...
     * Sets validation_key
     *
     * @param string|null $validation_key A value to be retrieved from a call to PlanBlockMigration, to confirm that the volume and/or snapshots specified in said plan should be migrated.
     *
     * @return self
     */
