...
/**
 * SetSnapshotRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SetSnapshotRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetSnapshot_request';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'organization' => 'string',
        'volume_type' => '\OpenAPI\Client\Model\ScalewayInstanceV1VolumeVolumeType',
        'size' => 'int',
        'state' => '\OpenAPI\Client\Model\ScalewayInstanceV1SnapshotState',
    ...
    */
     ...
     * Gets volume_type
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1VolumeVolumeType|null
     */
     ...
     * Sets volume_type
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1VolumeVolumeType|null $volume_type volume_type
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1SnapshotState|null
     */
     ...
     * Sets state
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1SnapshotState|null $state state
     *
     * @return self
     */
