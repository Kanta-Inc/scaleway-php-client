...
/**
 * PlanBlockMigrationRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PlanBlockMigrationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PlanBlockMigration_request';
    ...
    */
     ...
     * Sets volume_id
     *
     * @param string|null $volume_id The volume for which the migration plan will be generated.
     *
     * @return self
     */
     ...
     * Sets snapshot_id
     *
     * @param string|null $snapshot_id The snapshot for which the migration plan will be generated.
     *
     * @return self
     */
