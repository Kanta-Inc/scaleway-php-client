...
/**
 * ScalewayInstanceV1ServerAction Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ScalewayInstanceV1ServerAction
{
    /**
     * Possible values of this enum
     */
    public const POWERON = 'poweron';

    public const BACKUP = 'backup';

    public const STOP_IN_PLACE = 'stop_in_place';

    public const POWEROFF = 'poweroff';

    public const TERMINATE = 'terminate';

    public const REBOOT = 'reboot';

    public const ENABLE_ROUTED_IP = 'enable_routed_ip';
