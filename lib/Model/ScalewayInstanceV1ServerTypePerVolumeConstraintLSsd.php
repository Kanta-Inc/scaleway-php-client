...
/**
 * ScalewayInstanceV1ServerTypePerVolumeConstraintLSsd Class Doc Comment
 *
 * @category Class
 ...
 */
class ScalewayInstanceV1ServerTypePerVolumeConstraintLSsd implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway_instance_v1_ServerType_per_volume_constraint_l_ssd';
    ...
    */
     ...
     * Sets min_size
     *
     * @param int|null $min_size Minimum volume size in bytes. (in bytes)
     *
     * @return self
     */
     ...
     * Sets max_size
     *
     * @param int|null $max_size Maximum volume size in bytes. (in bytes)
     *
     * @return self
     */
