...
/**
 * ScalewayInstanceV1CreateSnapshotResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1CreateSnapshotResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway.instance.v1.CreateSnapshotResponse';
    ...
    protected static $openAPITypes = [
        'snapshot' => '\OpenAPI\Client\Model\ScalewayInstanceV1Snapshot',
        'task' => '\OpenAPI\Client\Model\ScalewayInstanceV1Task'
    ];
    ...
    */
     ...
     * Sets snapshot
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1Snapshot|null $snapshot snapshot
     *
     * @return self
     */
     ...
     * Gets task
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1Task|null
     */
     ...
     * Sets task
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1Task|null $task task
     *
     * @return self
     */
