...
/**
 * ScalewayInstanceV1MigrationPlan Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1MigrationPlan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway.instance.v1.MigrationPlan';
    ...
    protected static $openAPITypes = [
        'volume' => '\OpenAPI\Client\Model\ScalewayInstanceV1MigrationPlanVolume',
        'snapshots' => '\OpenAPI\Client\Model\ScalewayInstanceV1Snapshot[]',
    ...
    protected static $setters = [
        ...
        'validation_key' => 'setValidationKey'
    ];
    ...
    protected static $getters = [
        ...
        'validation_key' => 'getValidationKey'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('validation_key', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets volume
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1MigrationPlanVolume|null
     */
     ...
     * Sets volume
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1MigrationPlanVolume|null $volume volume
     *
     * @return self
     */
     ...
     * Gets snapshots
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1Snapshot[]|null
     */
     ...
     * Sets snapshots
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1Snapshot[]|null $snapshots A list of snapshots which will be migrated to SBS together and with the volume, if present.
     *
     * @return self
     */
    ...
    {
        return $this->container['validation_key'];
    }

    /**
     * Sets validation_key
     *
     * @param string|null $validation_key A value to be passed to ApplyBlockMigrationRequest, to confirm that the execution of the plan is being requested.
     *
     * @return self
     */
    public function setValidationKey($validation_key)
    {
        if (is_null($validation_key)) {
            throw new \InvalidArgumentException('non-nullable validation_key cannot be null');
        }
        $this->container['validation_key'] = $validation_key;
