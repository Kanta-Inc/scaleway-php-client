...
/**
 * ScalewayInstanceV1ServerImage Class Doc Comment
 *
 * @category Class
 ...
 */
class ScalewayInstanceV1ServerImage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway_instance_v1_Server_image';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'name' => 'string',
        'arch' => '\OpenAPI\Client\Model\ScalewayInstanceV1Arch',
        'creation_date' => '\DateTime',
        'modification_date' => '\DateTime',
        'default_bootscript' => '\OpenAPI\Client\Model\ScalewayInstanceV1Bootscript',
        'extra_volumes' => '\OpenAPI\Client\Model\SetImageRequestExtraVolumes',
        'from_server' => 'string',
        'organization' => 'string',
        'public' => 'bool',
        'root_volume' => '\OpenAPI\Client\Model\ScalewayInstanceV1VolumeSummary',
        'state' => '\OpenAPI\Client\Model\ScalewayInstanceV1ImageState',
        'project' => 'string',
        'tags' => 'string[]',
        'zone' => 'string'
    ];
    ...
    protected static $setters = [
        ...
        'default_bootscript' => 'setDefaultBootscript',
        'extra_volumes' => 'setExtraVolumes',
        'from_server' => 'setFromServer',
    ...
    protected static $getters = [
        ...
        'default_bootscript' => 'getDefaultBootscript',
        'extra_volumes' => 'getExtraVolumes',
        'from_server' => 'getFromServer',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('default_bootscript', $data ?? [], null);
        $this->setIfExists('extra_volumes', $data ?? [], null);
        $this->setIfExists('from_server', $data ?? [], null);
        $this->setIfExists('organization', $data ?? [], null);
        $this->setIfExists('public', $data ?? [], null);
        $this->setIfExists('root_volume', $data ?? [], null);
    ...
    */
     ...
     * Gets arch
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1Arch|null
     */
     ...
     * Sets arch
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1Arch|null $arch arch
     *
     * @return self
     */
     ...
     * Sets creation_date
     *
     * @param \DateTime|null $creation_date (RFC 3339 format)
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $modification_date (RFC 3339 format)
     *
     * @return self
     */
    ...
    /**
     * Gets default_bootscript
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1Bootscript|null
     */
    public function getDefaultBootscript()
    {
        return $this->container['default_bootscript'];
    }

    /**
     * Sets default_bootscript
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1Bootscript|null $default_bootscript default_bootscript
     *
     * @return self
     */
    public function setDefaultBootscript($default_bootscript)
    {
        if (is_null($default_bootscript)) {
            throw new \InvalidArgumentException('non-nullable default_bootscript cannot be null');
        }
        $this->container['default_bootscript'] = $default_bootscript;
     ...
     * Gets extra_volumes
     *
     * @return \OpenAPI\Client\Model\SetImageRequestExtraVolumes|null
     */
    public function getExtraVolumes()
    {
        return $this->container['extra_volumes'];
    }

    /**
     * Sets extra_volumes
     *
     * @param \OpenAPI\Client\Model\SetImageRequestExtraVolumes|null $extra_volumes extra_volumes
     *
     * @return self
     */
    public function setExtraVolumes($extra_volumes)
    {
        if (is_null($extra_volumes)) {
            throw new \InvalidArgumentException('non-nullable extra_volumes cannot be null');
        }
        $this->container['extra_volumes'] = $extra_volumes;
    ...
    {
        return $this->container['from_server'];
    }

    /**
     * Sets from_server
     *
     * @param string|null $from_server from_server
     *
     * @return self
     */
    public function setFromServer($from_server)
    {
        if (is_null($from_server)) {
            throw new \InvalidArgumentException('non-nullable from_server cannot be null');
        }
        $this->container['from_server'] = $from_server;
     ...
     * Gets root_volume
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1VolumeSummary|null
     */
     ...
     * Sets root_volume
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1VolumeSummary|null $root_volume root_volume
     *
     * @return self
     */
    public function setRootVolume($root_volume)
    {
        if (is_null($root_volume)) {
            throw new \InvalidArgumentException('non-nullable root_volume cannot be null');
        }
     ...
     * Gets state
     *
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1ImageState|null
     */
     ...
     * Sets state
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1ImageState|null $state state
     *
     * @return self
     */
