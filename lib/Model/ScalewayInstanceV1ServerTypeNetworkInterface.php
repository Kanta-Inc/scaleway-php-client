...
/**
 * ScalewayInstanceV1ServerTypeNetworkInterface Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1ServerTypeNetworkInterface implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway.instance.v1.ServerType.Network.Interface';
    ...
    protected static array $openAPINullables = [
        'internal_bandwidth' => true,
        'internet_bandwidth' => true
    ];
    ...
    protected static $setters = [
        'internal_bandwidth' => 'setInternalBandwidth',
        'internet_bandwidth' => 'setInternetBandwidth'
    ];
    ...
    protected static $getters = [
        'internal_bandwidth' => 'getInternalBandwidth',
        'internet_bandwidth' => 'getInternetBandwidth'
    ];
    ...
    {
        $this->setIfExists('internal_bandwidth', $data ?? [], null);
        $this->setIfExists('internet_bandwidth', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets internal_bandwidth
     *
     * @return int|null
     */
    public function getInternalBandwidth()
    {
        return $this->container['internal_bandwidth'];
    }

    /**
     * Sets internal_bandwidth
     *
     * @param int|null $internal_bandwidth Maximum internal bandwidth in bits per seconds.
     *
     * @return self
     */
    public function setInternalBandwidth($internal_bandwidth)
    {
        if (is_null($internal_bandwidth)) {
            array_push($this->openAPINullablesSetToNull, 'internal_bandwidth');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('internal_bandwidth', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['internal_bandwidth'] = $internal_bandwidth;

        return $this;
    }

    /**
     * Gets internet_bandwidth
     *
     * @return int|null
     */
    public function getInternetBandwidth()
    {
        return $this->container['internet_bandwidth'];
    }

    /**
     * Sets internet_bandwidth
     *
     * @param int|null $internet_bandwidth Maximum internet bandwidth in bits per seconds.
     *
     * @return self
     */
    public function setInternetBandwidth($internet_bandwidth)
    {
        if (is_null($internet_bandwidth)) {
            array_push($this->openAPINullablesSetToNull, 'internet_bandwidth');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('internet_bandwidth', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['internet_bandwidth'] = $internet_bandwidth;
