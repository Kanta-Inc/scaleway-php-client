...
/**
 * ScalewayInstanceV1ServerSecurityGroup Class Doc Comment
 *
 * @category Class
 ...
 */
class ScalewayInstanceV1ServerSecurityGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway_instance_v1_Server_security_group';
