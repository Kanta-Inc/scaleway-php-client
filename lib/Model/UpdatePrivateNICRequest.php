...
/**
 * UpdatePrivateNICRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdatePrivateNICRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePrivateNIC_request';
    ...
    */
     ...
     * Sets tags
     *
     * @param string[]|null $tags Tags used to select private NIC/s.
     *
     * @return self
     */
