...
/**
 * ScalewayInstanceV1ServerActionRequestVolumeBackupTemplate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1ServerActionRequestVolumeBackupTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway.instance.v1.ServerActionRequest.VolumeBackupTemplate';
    ...
    */
     ...
     * Sets volume_type
     *
     * @param string|null $volume_type Snapshot's volume type. Overrides the `volume_type` of the snapshot for this volume. If omitted, the volume type of the original volume will be used.
     *
     * @return self
     */
