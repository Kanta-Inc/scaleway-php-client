...
/**
 * ScalewayInstanceV1ServerIpv6 Class Doc Comment
 *
 * @category Class
 ...
 */
class ScalewayInstanceV1ServerIpv6 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway_instance_v1_Server_ipv6';
    ...
    */
     ...
     * Sets address
     *
     * @param string|null $address Instance IPv6 IP-Address. (IPv6 address)
     *
     * @return self
     */
     ...
     * Sets gateway
     *
     * @param string|null $gateway IPv6 IP-addresses gateway. (IPv6 address)
     *
     * @return self
     */
     ...
     * Sets netmask
     *
     * @param string|null $netmask IPv6 IP-addresses CIDR netmask.
     *
     * @return self
     */
