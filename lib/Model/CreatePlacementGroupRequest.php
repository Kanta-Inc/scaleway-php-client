...
/**
 * CreatePlacementGroupRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatePlacementGroupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePlacementGroup_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Name of the placement group.
     *
     * @return self
     */
     ...
     * Sets organization
     *
     * @param string|null $organization Organization ID of the placement group.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets project
     *
     * @param string|null $project Project ID of the placement group.
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags Tags of the placement group.
     *
     * @return self
     */
     ...
     * Sets policy_mode
     *
     * @param string|null $policy_mode Operating mode of the placement group.
     *
     * @return self
     */
     ...
     * Sets policy_type
     *
     * @param string|null $policy_type Policy type of the placement group.
     *
     * @return self
     */
