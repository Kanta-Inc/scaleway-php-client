...
/**
 * ScalewayInstanceV1DashboardServersByTypes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1DashboardServersByTypes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway_instance_v1_Dashboard_servers_by_types';
    ...
    protected static $attributeMap = [
        'servers_by_type_key' => '&lt;servers_by_typeKey&gt;'
    ];
    ...
    protected static $setters = [
        'servers_by_type_key' => 'setServersByTypeKey'
    ];
    ...
    protected static $getters = [
        'servers_by_type_key' => 'getServersByTypeKey'
    ];
    ...
    {
        $this->setIfExists('servers_by_type_key', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets servers_by_type_key
     *
     * @return int|null
     */
    public function getServersByTypeKey()
    {
        return $this->container['servers_by_type_key'];
    }

    /**
     * Sets servers_by_type_key
     *
     * @param int|null $servers_by_type_key servers_by_type_key
     *
     * @return self
     */
    public function setServersByTypeKey($servers_by_type_key)
    {
        if (is_null($servers_by_type_key)) {
            throw new \InvalidArgumentException('non-nullable servers_by_type_key cannot be null');
        }
        $this->container['servers_by_type_key'] = $servers_by_type_key;
