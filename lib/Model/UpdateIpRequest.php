...
/**
 * UpdateIpRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateIpRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateIp_request';
    ...
    */
     ...
     * Sets reverse
     *
     * @param string|null $reverse Reverse domain name.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Convert a 'nat' IP to a 'routed_ipv4'.
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags An array of keywords you want to tag this IP with.
     *
     * @return self
     */
