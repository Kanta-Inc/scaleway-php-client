...
/**
 * SetVolumeRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SetVolumeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetVolume_request';
    ...
    */
     ...
     * Sets tags
     *
     * @param string[]|null $tags Tags of the volume.
     *
     * @return self
     */
     ...
     * Sets export_uri
     *
     * @param string|null $export_uri Show the volumes NBD export URI, this field is ignored.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets size
     *
     * @param int|null $size Volume's disk size, must be a multiple of 512. (in bytes)
     *
     * @return self
     */
