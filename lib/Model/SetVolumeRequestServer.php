...
/**
 * SetVolumeRequestServer Class Doc Comment
 *
 * @category Class
 ...
 */
class SetVolumeRequestServer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetVolume_request_server';
