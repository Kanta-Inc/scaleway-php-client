...
/**
 * UpdateImageRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateImageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateImage_request';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'arch' => 'string',
        'extra_volumes' => '\OpenAPI\Client\Model\UpdateImageRequestExtraVolumes',
        'tags' => 'string[]',
        'public' => 'bool'
    ];
    ...
    */
     ...
     * Sets arch
     *
     * @param string|null $arch Architecture of the image.
     *
     * @return self
     */
     ...
     * Gets extra_volumes
     *
     * @return \OpenAPI\Client\Model\UpdateImageRequestExtraVolumes|null
     */
     ...
     * Sets extra_volumes
     *
     * @param \OpenAPI\Client\Model\UpdateImageRequestExtraVolumes|null $extra_volumes extra_volumes
     *
     * @return self
     */
     ...
     * Sets public
     *
     * @param bool|null $public True to set the image as public.
     *
     * @return self
     */
