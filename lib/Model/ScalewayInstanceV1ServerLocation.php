...
/**
 * ScalewayInstanceV1ServerLocation Class Doc Comment
 *
 * @category Class
 ...
 */
class ScalewayInstanceV1ServerLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway_instance_v1_Server_location';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('hypervisor_id', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getHypervisorId()
    {
        return $this->container['hypervisor_id'];
    }

    /**
     * Sets hypervisor_id
     *
     * @param string|null $hypervisor_id hypervisor_id
     *
     * @return self
     */
    public function setHypervisorId($hypervisor_id)
    {
        if (is_null($hypervisor_id)) {
            throw new \InvalidArgumentException('non-nullable hypervisor_id cannot be null');
        }
        $this->container['hypervisor_id'] = $hypervisor_id;
