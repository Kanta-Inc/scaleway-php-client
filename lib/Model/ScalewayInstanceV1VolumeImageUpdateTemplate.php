...
/**
 * ScalewayInstanceV1VolumeImageUpdateTemplate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1VolumeImageUpdateTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway.instance.v1.VolumeImageUpdateTemplate';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id UUID of the snapshot. (UUID format)
     *
     * @return self
     */
