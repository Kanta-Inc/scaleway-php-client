...
/**
 * SetPlacementGroupServersRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SetPlacementGroupServersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetPlacementGroupServers_request';
    ...
    */
     ...
     * Sets servers
     *
     * @param string[] $servers An array of the Instances' UUIDs you want to configure.
     *
     * @return self
     */
