...
class ServerActionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServerAction_request';
    ...
    protected static $openAPITypes = [
        'action' => 'string',
        'name' => 'string',
        'volumes' => '\OpenAPI\Client\Model\ServerActionRequestVolumes'
    ];
    ...
    public const ACTION_POWERON = 'poweron';
    public const ACTION_BACKUP = 'backup';
    public const ACTION_STOP_IN_PLACE = 'stop_in_place';
    public const ACTION_POWEROFF = 'poweroff';
    public const ACTION_TERMINATE = 'terminate';
    public const ACTION_REBOOT = 'reboot';
    public const ACTION_ENABLE_ROUTED_IP = 'enable_routed_ip';
    ...
    public function getActionAllowableValues()
    {
        return [
            self::ACTION_POWERON,
            self::ACTION_BACKUP,
            self::ACTION_STOP_IN_PLACE,
            self::ACTION_POWEROFF,
            self::ACTION_TERMINATE,
            self::ACTION_REBOOT,
            self::ACTION_ENABLE_ROUTED_IP,
        ];
    }
    ...
    {
        $this->setIfExists('action', $data ?? [], 'poweron');
    ...
    */
     ...
     * Sets action
     *
     * @param string|null $action Action to perform on the Instance.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name of the backup you want to create. Name of the backup you want to create. This field should only be specified when performing a backup action.
     *
     * @return self
     */
     ...
     * Gets volumes
     *
     * @return \OpenAPI\Client\Model\ServerActionRequestVolumes|null
     */
     ...
     * Sets volumes
     *
     * @param \OpenAPI\Client\Model\ServerActionRequestVolumes|null $volumes volumes
     *
     * @return self
     */
