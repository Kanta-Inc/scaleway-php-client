...
/**
 * ScalewayInstanceV1CreateSecurityGroupRuleResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1CreateSecurityGroupRuleResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway.instance.v1.CreateSecurityGroupRuleResponse';
    ...
    protected static $openAPITypes = [
        'rule' => '\OpenAPI\Client\Model\ScalewayInstanceV1SecurityGroupRule'
    ];
    ...
    */
     ...
     * Sets rule
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1SecurityGroupRule|null $rule rule
     *
     * @return self
     */
