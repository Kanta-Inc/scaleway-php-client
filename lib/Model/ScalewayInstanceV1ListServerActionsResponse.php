...
/**
 * ScalewayInstanceV1ListServerActionsResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScalewayInstanceV1ListServerActionsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scaleway.instance.v1.ListServerActionsResponse';
    ...
    protected static $openAPITypes = [
        'actions' => '\OpenAPI\Client\Model\ScalewayInstanceV1ServerAction[]'
    ];
    ...
    */
     ...
     * Sets actions
     *
     * @param \OpenAPI\Client\Model\ScalewayInstanceV1ServerAction[]|null $actions actions
     *
     * @return self
     */
