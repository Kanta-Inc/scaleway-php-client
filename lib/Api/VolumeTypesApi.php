...
class VolumeTypesApi
{
     ...
     */
    public function listVolumesTypes($zone, $per_page = null, $page = 1, string $contentType = self::contentTypes['listVolumesTypes'][0])
    {
     ...
     */
    public function listVolumesTypesWithHttpInfo($zone, $per_page = null, $page = 1, string $contentType = self::contentTypes['listVolumesTypes'][0])
    {
     ...
     */
    public function listVolumesTypesAsync($zone, $per_page = null, $page = 1, string $contentType = self::contentTypes['listVolumesTypes'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listVolumesTypesAsyncWithHttpInfo($zone, $per_page = null, $page = 1, string $contentType = self::contentTypes['listVolumesTypes'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ScalewayInstanceV1ListVolumesTypesResponse';
        $request = $this->listVolumesTypesRequest($zone, $per_page, $page, $contentType);
     ...
     */
    public function listVolumesTypesRequest($zone, $per_page = null, $page = 1, string $contentType = self::contentTypes['listVolumesTypes'][0])
    {
