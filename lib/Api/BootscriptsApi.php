...
/**
 * BootscriptsApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class BootscriptsApi
{
     ...
     * @param  string $bootscript_id bootscript_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getBootscript'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1GetBootscriptResponse
     * @deprecated
     */
    public function getBootscript($zone, $bootscript_id, string $contentType = self::contentTypes['getBootscript'][0])
    {
        list($response) = $this->getBootscriptWithHttpInfo($zone, $bootscript_id, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $zone The zone you want to target (required)
     * @param  string $bootscript_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getBootscript'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ScalewayInstanceV1GetBootscriptResponse, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function getBootscriptWithHttpInfo($zone, $bootscript_id, string $contentType = self::contentTypes['getBootscript'][0])
    {
        $request = $this->getBootscriptRequest($zone, $bootscript_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ScalewayInstanceV1GetBootscriptResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ScalewayInstanceV1GetBootscriptResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ScalewayInstanceV1GetBootscriptResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\ScalewayInstanceV1GetBootscriptResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ScalewayInstanceV1GetBootscriptResponse',
     ...
     * @deprecated
     */
    public function getBootscriptAsync($zone, $bootscript_id, string $contentType = self::contentTypes['getBootscript'][0])
    {
        return $this->getBootscriptAsyncWithHttpInfo($zone, $bootscript_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function getBootscriptAsyncWithHttpInfo($zone, $bootscript_id, string $contentType = self::contentTypes['getBootscript'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ScalewayInstanceV1GetBootscriptResponse';
        $request = $this->getBootscriptRequest($zone, $bootscript_id, $contentType);
     ...
     * @deprecated
     */
    public function getBootscriptRequest($zone, $bootscript_id, string $contentType = self::contentTypes['getBootscript'][0])
    {

        // verify the required parameter 'zone' is set
        if ($zone === null || (is_array($zone) && count($zone) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $zone when calling getBootscript'
            );
        }

        // verify the required parameter 'bootscript_id' is set
        if ($bootscript_id === null || (is_array($bootscript_id) && count($bootscript_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $bootscript_id when calling getBootscript'
            );
        }


        $resourcePath = '/instance/v1/zones/{zone}/bootscripts/{bootscript_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($bootscript_id !== null) {
            $resourcePath = str_replace(
                '{' . 'bootscript_id' . '}',
                ObjectSerializer::toPathValue($bootscript_id),
                $resourcePath
            );
        }
     ...
     * @param  bool $default default (optional)
     * @param  bool $public public (optional)
     * @param  int $per_page per_page (optional)
     * @param  int $page Page number (optional, default to 1)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listBootscripts'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1ListBootscriptsResponse
     * @deprecated
     */
    public function listBootscripts($zone, $arch = null, $title = null, $default = null, $public = null, $per_page = null, $page = 1, string $contentType = self::contentTypes['listBootscripts'][0])
    {
        list($response) = $this->listBootscriptsWithHttpInfo($zone, $arch, $title, $default, $public, $per_page, $page, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ScalewayInstanceV1ListBootscriptsResponse, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function listBootscriptsWithHttpInfo($zone, $arch = null, $title = null, $default = null, $public = null, $per_page = null, $page = 1, string $contentType = self::contentTypes['listBootscripts'][0])
    {
        $request = $this->listBootscriptsRequest($zone, $arch, $title, $default, $public, $per_page, $page, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ScalewayInstanceV1ListBootscriptsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ScalewayInstanceV1ListBootscriptsResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ScalewayInstanceV1ListBootscriptsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\ScalewayInstanceV1ListBootscriptsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ScalewayInstanceV1ListBootscriptsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function listBootscriptsAsync($zone, $arch = null, $title = null, $default = null, $public = null, $per_page = null, $page = 1, string $contentType = self::contentTypes['listBootscripts'][0])
    {
        return $this->listBootscriptsAsyncWithHttpInfo($zone, $arch, $title, $default, $public, $per_page, $page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function listBootscriptsAsyncWithHttpInfo($zone, $arch = null, $title = null, $default = null, $public = null, $per_page = null, $page = 1, string $contentType = self::contentTypes['listBootscripts'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ScalewayInstanceV1ListBootscriptsResponse';
        $request = $this->listBootscriptsRequest($zone, $arch, $title, $default, $public, $per_page, $page, $contentType);
     ...
     * @deprecated
     */
    public function listBootscriptsRequest($zone, $arch = null, $title = null, $default = null, $public = null, $per_page = null, $page = 1, string $contentType = self::contentTypes['listBootscripts'][0])
    {

        // verify the required parameter 'zone' is set
        if ($zone === null || (is_array($zone) && count($zone) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $zone when calling listBootscripts'
            );
        }
        ...
        $resourcePath = '/instance/v1/zones/{zone}/bootscripts';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
