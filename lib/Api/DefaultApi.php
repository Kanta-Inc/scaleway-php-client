...
class DefaultApi
{
    ...
    /**
     * Operation attachServerVolume
     *
     * @param  string $zone The zone you want to target (required)
     * @param  string $server_id server_id (required)
     * @param  \OpenAPI\Client\Model\AttachServerVolumeRequest $attach_server_volume_request attach_server_volume_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['attachServerVolume'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1AttachServerVolumeResponse
     */
    public function attachServerVolume($zone, $server_id, $attach_server_volume_request, string $contentType = self::contentTypes['attachServerVolume'][0])
    {
        list($response) = $this->attachServerVolumeWithHttpInfo($zone, $server_id, $attach_server_volume_request, $contentType);
        return $response;
    }

    /**
     * Operation attachServerVolumeWithHttpInfo
     *
     * @param  string $zone The zone you want to target (required)
     * @param  string $server_id (required)
     * @param  \OpenAPI\Client\Model\AttachServerVolumeRequest $attach_server_volume_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['attachServerVolume'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ScalewayInstanceV1AttachServerVolumeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function attachServerVolumeWithHttpInfo($zone, $server_id, $attach_server_volume_request, string $contentType = self::contentTypes['attachServerVolume'][0])
    {
        $request = $this->attachServerVolumeRequest($zone, $server_id, $attach_server_volume_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ScalewayInstanceV1AttachServerVolumeResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ScalewayInstanceV1AttachServerVolumeResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ScalewayInstanceV1AttachServerVolumeResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\ScalewayInstanceV1AttachServerVolumeResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ScalewayInstanceV1AttachServerVolumeResponse',
    ...
    /**
     * Operation attachServerVolumeAsync
     *
     * @param  string $zone The zone you want to target (required)
     * @param  string $server_id (required)
     * @param  \OpenAPI\Client\Model\AttachServerVolumeRequest $attach_server_volume_request (required)
     ...
     */
    public function attachServerVolumeAsync($zone, $server_id, $attach_server_volume_request, string $contentType = self::contentTypes['attachServerVolume'][0])
    {
        return $this->attachServerVolumeAsyncWithHttpInfo($zone, $server_id, $attach_server_volume_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation attachServerVolumeAsyncWithHttpInfo
     *
     * @param  string $zone The zone you want to target (required)
     * @param  string $server_id (required)
     * @param  \OpenAPI\Client\Model\AttachServerVolumeRequest $attach_server_volume_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function attachServerVolumeAsyncWithHttpInfo($zone, $server_id, $attach_server_volume_request, string $contentType = self::contentTypes['attachServerVolume'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ScalewayInstanceV1AttachServerVolumeResponse';
        $request = $this->attachServerVolumeRequest($zone, $server_id, $attach_server_volume_request, $contentType);
    ...
    /**
     * Create request for operation 'attachServerVolume'
     *
     * @param  string $zone The zone you want to target (required)
     * @param  string $server_id (required)
     * @param  \OpenAPI\Client\Model\AttachServerVolumeRequest $attach_server_volume_request (required)
     ...
     */
    public function attachServerVolumeRequest($zone, $server_id, $attach_server_volume_request, string $contentType = self::contentTypes['attachServerVolume'][0])
    {

        // verify the required parameter 'zone' is set
        if ($zone === null || (is_array($zone) && count($zone) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $zone when calling attachServerVolume'
            );
        }
        ...
        if ($server_id === null || (is_array($server_id) && count($server_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $server_id when calling attachServerVolume'
            );
        }

        // verify the required parameter 'attach_server_volume_request' is set
        if ($attach_server_volume_request === null || (is_array($attach_server_volume_request) && count($attach_server_volume_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $attach_server_volume_request when calling attachServerVolume'
            );
        }


        $resourcePath = '/instance/v1/zones/{zone}/servers/{server_id}/attach-volume';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($attach_server_volume_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($attach_server_volume_request));
            } else {
                $httpBody = $attach_server_volume_request;
            }
    ...
    /**
     * Operation detachServerVolume
     *
     * @param  string $zone The zone you want to target (required)
     * @param  string $server_id server_id (required)
     * @param  \OpenAPI\Client\Model\DetachServerVolumeRequest $detach_server_volume_request detach_server_volume_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['detachServerVolume'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1DetachServerVolumeResponse
     */
    public function detachServerVolume($zone, $server_id, $detach_server_volume_request, string $contentType = self::contentTypes['detachServerVolume'][0])
    {
        list($response) = $this->detachServerVolumeWithHttpInfo($zone, $server_id, $detach_server_volume_request, $contentType);
        return $response;
    }

    /**
     * Operation detachServerVolumeWithHttpInfo
     *
     * @param  string $zone The zone you want to target (required)
     * @param  string $server_id (required)
     * @param  \OpenAPI\Client\Model\DetachServerVolumeRequest $detach_server_volume_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['detachServerVolume'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ScalewayInstanceV1DetachServerVolumeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function detachServerVolumeWithHttpInfo($zone, $server_id, $detach_server_volume_request, string $contentType = self::contentTypes['detachServerVolume'][0])
    {
        $request = $this->detachServerVolumeRequest($zone, $server_id, $detach_server_volume_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ScalewayInstanceV1DetachServerVolumeResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ScalewayInstanceV1DetachServerVolumeResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ScalewayInstanceV1DetachServerVolumeResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\ScalewayInstanceV1DetachServerVolumeResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ScalewayInstanceV1DetachServerVolumeResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation detachServerVolumeAsync
     *
     * @param  string $zone The zone you want to target (required)
     * @param  string $server_id (required)
     * @param  \OpenAPI\Client\Model\DetachServerVolumeRequest $detach_server_volume_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function detachServerVolumeAsync($zone, $server_id, $detach_server_volume_request, string $contentType = self::contentTypes['detachServerVolume'][0])
    {
        return $this->detachServerVolumeAsyncWithHttpInfo($zone, $server_id, $detach_server_volume_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation detachServerVolumeAsyncWithHttpInfo
     *
     * @param  string $zone The zone you want to target (required)
     * @param  string $server_id (required)
     * @param  \OpenAPI\Client\Model\DetachServerVolumeRequest $detach_server_volume_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function detachServerVolumeAsyncWithHttpInfo($zone, $server_id, $detach_server_volume_request, string $contentType = self::contentTypes['detachServerVolume'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ScalewayInstanceV1DetachServerVolumeResponse';
        $request = $this->detachServerVolumeRequest($zone, $server_id, $detach_server_volume_request, $contentType);
    ...
    /**
     * Create request for operation 'detachServerVolume'
     *
     * @param  string $zone The zone you want to target (required)
     * @param  string $server_id (required)
     * @param  \OpenAPI\Client\Model\DetachServerVolumeRequest $detach_server_volume_request (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function detachServerVolumeRequest($zone, $server_id, $detach_server_volume_request, string $contentType = self::contentTypes['detachServerVolume'][0])
    {

        // verify the required parameter 'zone' is set
        if ($zone === null || (is_array($zone) && count($zone) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $zone when calling detachServerVolume'
            );
        }
        ...
        if ($server_id === null || (is_array($server_id) && count($server_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $server_id when calling detachServerVolume'
            );
        }

        // verify the required parameter 'detach_server_volume_request' is set
        if ($detach_server_volume_request === null || (is_array($detach_server_volume_request) && count($detach_server_volume_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $detach_server_volume_request when calling detachServerVolume'
            );
        }


        $resourcePath = '/instance/v1/zones/{zone}/servers/{server_id}/detach-volume';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($detach_server_volume_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($detach_server_volume_request));
            } else {
                $httpBody = $detach_server_volume_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1GetDashboardResponse
     */
    public function getDashboard($zone, $organization = null, $project = null, string $contentType = self::contentTypes['getDashboard'][0])
    {
        list($response) = $this->getDashboardWithHttpInfo($zone, $organization, $project, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ScalewayInstanceV1GetDashboardResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDashboardWithHttpInfo($zone, $organization = null, $project = null, string $contentType = self::contentTypes['getDashboard'][0])
    {
        $request = $this->getDashboardRequest($zone, $organization, $project, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ScalewayInstanceV1GetDashboardResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ScalewayInstanceV1GetDashboardResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ScalewayInstanceV1GetDashboardResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\ScalewayInstanceV1GetDashboardResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ScalewayInstanceV1GetDashboardResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDashboardAsync($zone, $organization = null, $project = null, string $contentType = self::contentTypes['getDashboard'][0])
    {
        return $this->getDashboardAsyncWithHttpInfo($zone, $organization, $project, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDashboardAsyncWithHttpInfo($zone, $organization = null, $project = null, string $contentType = self::contentTypes['getDashboard'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ScalewayInstanceV1GetDashboardResponse';
        $request = $this->getDashboardRequest($zone, $organization, $project, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDashboardRequest($zone, $organization = null, $project = null, string $contentType = self::contentTypes['getDashboard'][0])
    {

        // verify the required parameter 'zone' is set
        if ($zone === null || (is_array($zone) && count($zone) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $zone when calling getDashboard'
            );
        }
        ...
        $resourcePath = '/instance/v1/zones/{zone}/dashboard';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
