...
/**
 * InstanceTypesApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class InstanceTypesApi
{
    ...
    /**
     * Operation getServerTypesAvailability
     *
     * Get availability
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getServerTypesAvailability'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1GetServerTypesAvailabilityResponse
     */
    public function getServerTypesAvailability($zone, $per_page = null, $page = 1, string $contentType = self::contentTypes['getServerTypesAvailability'][0])
    {
        list($response) = $this->getServerTypesAvailabilityWithHttpInfo($zone, $per_page, $page, $contentType);
        return $response;
    }

    /**
     * Operation getServerTypesAvailabilityWithHttpInfo
     *
     * Get availability
     *
     * @param  string $zone The zone you want to target (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ScalewayInstanceV1GetServerTypesAvailabilityResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getServerTypesAvailabilityWithHttpInfo($zone, $per_page = null, $page = 1, string $contentType = self::contentTypes['getServerTypesAvailability'][0])
    {
        $request = $this->getServerTypesAvailabilityRequest($zone, $per_page, $page, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ScalewayInstanceV1GetServerTypesAvailabilityResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ScalewayInstanceV1GetServerTypesAvailabilityResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ScalewayInstanceV1GetServerTypesAvailabilityResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\ScalewayInstanceV1GetServerTypesAvailabilityResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ScalewayInstanceV1GetServerTypesAvailabilityResponse',
    ...
    /**
     * Operation getServerTypesAvailabilityAsync
     *
     * Get availability
     *
     * @param  string $zone The zone you want to target (required)
     ...
     */
    public function getServerTypesAvailabilityAsync($zone, $per_page = null, $page = 1, string $contentType = self::contentTypes['getServerTypesAvailability'][0])
    {
        return $this->getServerTypesAvailabilityAsyncWithHttpInfo($zone, $per_page, $page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getServerTypesAvailabilityAsyncWithHttpInfo
     *
     * Get availability
     *
     * @param  string $zone The zone you want to target (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getServerTypesAvailabilityAsyncWithHttpInfo($zone, $per_page = null, $page = 1, string $contentType = self::contentTypes['getServerTypesAvailability'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ScalewayInstanceV1GetServerTypesAvailabilityResponse';
        $request = $this->getServerTypesAvailabilityRequest($zone, $per_page, $page, $contentType);
    ...
    /**
     * Create request for operation 'getServerTypesAvailability'
     *
     * @param  string $zone The zone you want to target (required)
     * @param  int $per_page A positive integer lower or equal to 100 to select the number of items to return. (optional)
     * @param  int $page A positive integer to choose the page to return. (optional, default to 1)
     ...
     */
    public function getServerTypesAvailabilityRequest($zone, $per_page = null, $page = 1, string $contentType = self::contentTypes['getServerTypesAvailability'][0])
    {

        // verify the required parameter 'zone' is set
        if ($zone === null || (is_array($zone) && count($zone) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $zone when calling getServerTypesAvailability'
            );
        }
        ...
        $resourcePath = '/instance/v1/zones/{zone}/products/servers/availability';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listServersTypes'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ScalewayInstanceV1ListServersTypesResponse
     */
    public function listServersTypes($zone, $per_page = null, $page = 1, string $contentType = self::contentTypes['listServersTypes'][0])
    {
        list($response) = $this->listServersTypesWithHttpInfo($zone, $per_page, $page, $contentType);
        return $response;
    }

    /**
     * Operation listServersTypesWithHttpInfo
     *
     * List Instance types
     *
     * @param  string $zone The zone you want to target (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ScalewayInstanceV1ListServersTypesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listServersTypesWithHttpInfo($zone, $per_page = null, $page = 1, string $contentType = self::contentTypes['listServersTypes'][0])
    {
        $request = $this->listServersTypesRequest($zone, $per_page, $page, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ScalewayInstanceV1ListServersTypesResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ScalewayInstanceV1ListServersTypesResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ScalewayInstanceV1ListServersTypesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\ScalewayInstanceV1ListServersTypesResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ScalewayInstanceV1ListServersTypesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation listServersTypesAsync
     *
     * List Instance types
     *
     * @param  string $zone The zone you want to target (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listServersTypesAsync($zone, $per_page = null, $page = 1, string $contentType = self::contentTypes['listServersTypes'][0])
    {
        return $this->listServersTypesAsyncWithHttpInfo($zone, $per_page, $page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listServersTypesAsyncWithHttpInfo
     *
     * List Instance types
     *
     * @param  string $zone The zone you want to target (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listServersTypesAsyncWithHttpInfo($zone, $per_page = null, $page = 1, string $contentType = self::contentTypes['listServersTypes'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ScalewayInstanceV1ListServersTypesResponse';
        $request = $this->listServersTypesRequest($zone, $per_page, $page, $contentType);
    ...
    /**
     * Create request for operation 'listServersTypes'
     *
     * @param  string $zone The zone you want to target (required)
     * @param  int $per_page (optional)
     * @param  int $page Page number (optional, default to 1)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listServersTypesRequest($zone, $per_page = null, $page = 1, string $contentType = self::contentTypes['listServersTypes'][0])
    {

        // verify the required parameter 'zone' is set
        if ($zone === null || (is_array($zone) && count($zone) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $zone when calling listServersTypes'
            );
        }
        ...
        $resourcePath = '/instance/v1/zones/{zone}/products/servers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
